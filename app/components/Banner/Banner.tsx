...
const Banner = () => {
  return (
    <section
      className="min-h-[75vh] lg:min-h-[78vh] p-8 flex items-center bg-black"
      id="home"
    >
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12">
          ...
          <div className="mb-6 flex-1 text-center font-secondary lg:text-left">
            ...
            >
              Welcome to Crenius Studio, your premier destination for top-notch
              graphic design, digital marketing, app development, and website
              solutions.
            </motion.p>
          </div>
